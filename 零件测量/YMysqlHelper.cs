...
namespace YF.Utility
{
    class YMysqlHelper
    {
        public static class MysqlHelper
        {
            ...
            //public static string connectionString = "server=36z54702s4.wicp.vip;port=54944;user=root;password=123456;database=celiang;Allow User Variables=True";
            //public static string connectionString = "server=free.svipss.top; port=14878;user=root;password=123456;database=celiang;Allow User Variables=True";
            public static string connectionString = "127.0.0.1; port=3306;user=root;password=123456;database=celiang;Allow User Variables=True";
            //public static string connectionString = "server=192.168.0.100;port=3306;user=root;password=123456;database=celiang;Allow User Variables=True";
            ...
            public static void ExecuteNoQueryTran(List<String> SQLStringList)
            {
